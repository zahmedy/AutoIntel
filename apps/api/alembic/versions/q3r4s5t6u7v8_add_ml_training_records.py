...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_mltrainingrecord_price_prediction_created_at"), table_name="mltrainingrecord")
    op.drop_index(op.f("ix_mltrainingrecord_price_prediction"), table_name="mltrainingrecord")
    op.drop_index(op.f("ix_mltrainingrecord_price_model_version"), table_name="mltrainingrecord")
    op.drop_index(op.f("ix_mltrainingrecord_price_model_name"), table_name="mltrainingrecord")
